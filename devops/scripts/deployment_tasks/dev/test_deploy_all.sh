...
git clone git@github.com:eardish/conductor-gateway.git -b f-new-socket
git clone git@github.com:eardish/email-service.git
git clone git@github.com:eardish/auth-service.git
git clone git@github.com:eardish/conductor-bridge.git -b f-new-socket
git clone git@github.com:eardish/user-service.git
git clone git@github.com:eardish/profile-service.git -b f-new-socket
