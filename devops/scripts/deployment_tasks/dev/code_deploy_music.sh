...
# this script is used for deploying code to the music services 
...
rm -rf /home/$admin/backups/music.tar.gz
...
#for rec_app in ${rec[@]}
#do
#ssh $admin@$rec_app /home/$admin/devops/scripts/deployment_tasks/task_composercomposer_rec.sh
#done
