...
git clone git@github.com:eardish/artools-client.git -b f-socket-closure
git clone git@github.com:eardish/conductor-gateway.git -b f-socket-closure
git clone git@github.com:eardish/email-service.git -b f-socket-closure
git clone git@github.com:eardish/auth-service.git -b f-socket-closure
git clone git@github.com:eardish/conductor-bridge.git -b f-socket-closure
git clone git@github.com:eardish/user-service.git -b f-socket-closure
git clone git@github.com:eardish/profile-service.git -b f-socket-closure
git clone git@github.com:eardish/recommendation-service.git -b f-socket-closure
git clone git@github.com:eardish/analytics-service.git -b f-socket-closure
git clone git@github.com:eardish/music-service.git -b f-socket-closure
git clone git@github.com:eardish/image-processing-service.git -b f-socket-closure
git clone git@github.com:eardish/song-ingestion-service.git -b f-socket-closure
git clone git@github.com:eardish/conductor-dataobjects.git -b f-socket-closure
git clone git@github.com:eardish/db-cron.git -b f-socket-closure
git clone git@github.com:eardish/notation.git -b f-socket-closure
