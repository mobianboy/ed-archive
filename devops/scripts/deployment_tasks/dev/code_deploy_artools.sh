...
sed -i 's/REPLACE_IP/apidev.eardishcorp.com/g' /home/$admin/code/artools-client/js/app.js
sed -i 's/REPLACE_IMAGE_BUCKET/eardish.dev.images/g' /home/$admin/code/artools-client/js/app.js
sed -i 's/REPLACE_SONG_BUCKET/eardish.dev.songs/g' /home/$admin/code/artools-client/js/app.js
