...
# this script is used for deploying code to the ARTools Sites 
...
rm -rf /home/$admin/backups/artools.tar.gz
...
echo bucket/ip string replacement

sed -i 's/REPLACE_IP/apiqa.eardish.com/g' /home/$admin/code/artools-client/js/app.js
sed -i 's/REPLACE_IMAGE_BUCKET/eardish.qa.images/g' /home/$admin/code/artools-client/js/app.js
sed -i 's/REPLACE_SONG_BUCKET/eardish.qa.songs/g' /home/$admin/code/artools-client/js/app.js
#done
