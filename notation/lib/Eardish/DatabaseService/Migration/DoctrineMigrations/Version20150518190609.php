 ...
 */
class Version20150518190609 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE profile ALTER bio TYPE VARCHAR(255)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE profile ALTER bio TYPE TEXT');
        $this->addSql('ALTER TABLE profile ALTER bio DROP DEFAULT');
    }
}
