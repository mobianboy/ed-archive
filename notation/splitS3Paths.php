...
use Eardish\DatabaseService\DatabaseControllers\SeedControllers\Seeders\Scripts\DBScript;
...
$dbScript = new DBScript($numElements, $config, $secretConfig);
$dbScript->splits3Paths();
