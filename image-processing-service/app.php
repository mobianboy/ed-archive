...
use \Eardish\ImageProcessingService\ServiceKernel;
use \Eardish\ImageProcessingService\ImageProcessingService;
...
const CONFIG_SERVICE_NAME = 'imageprocessing';

// Name used for other output
const ACTUAL_SERVICE_NAME = 'Image Processing Service';
...
$kernel->setService(new ImageProcessingService(new Connection(), $kernel, $config));
$serviceId = 1;
