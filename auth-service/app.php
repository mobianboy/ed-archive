...
use \Eardish\AuthService\AuthService;
...
const CONFIG_SERVICE_NAME = 'auth';

// Name used for other output
const ACTUAL_SERVICE_NAME = 'Auth Service';
...
// set notice/error to exception handler
...
$kernel->setService(new AuthService(new Connection(), $kernel, $config));
