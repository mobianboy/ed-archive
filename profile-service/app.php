...
use Eardish\ProfileService\ProfileService;
...
const CONFIG_SERVICE_NAME = 'profile';

// Name used for other output
const ACTUAL_SERVICE_NAME = 'Profile Service';
...
$kernel->setService(new ProfileService(new Connection(), $kernel, $config));
